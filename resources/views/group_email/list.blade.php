            ...
            <tbody>
                @foreach ($email_group as $value)
                    <tr>
                        ...
                        <td><a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete{{ $value->group_id }}"><i class="bi bi-trash"></i></a></td>
                    </tr>
                    <!-- Delete Template -->
                    <div class="modal fade" id="delete{{ $value->group_id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ url('user-email/group/destroy') }}/{{ $value->group_id }}" method="POST">
                                    @csrf
